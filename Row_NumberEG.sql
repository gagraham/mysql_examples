...
`from_date`,
`to_date`,
IF(`salary_amount` < @dummy_salary_amount AND @dummy_salary_amount !=
0, 'lower than last', 'higher') AS comparison,
@row_number := IF(`employee_id` != @dummy_employee_id, 1, @row_number
+ 1) AS '@row_number',
